document.addEventListener("DOMContentLoaded", function () {
  ...
  const navbarHTML = `
        ...
        <ul class="mi-menu" id="nav-menu">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="javascript:void(0);" onclick="document.FormaIndex.submit();"><i class="fas fa-info-circle"></i> Estado de Perfil</a>
              <a class="dropdown-item" href="javascript:void(0);" onclick="document.FormaUpdate.submit();"><i class="fas fa-edit"></i> Actualizar Datos</a>
              <a class="dropdown-item" href="javascript:void(0);" onclick="document.FormaConfig.submit();"><i class="fas fa-cogs"></i> Configuración</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item text-danger" href="javascript:void(0);" onclick="document.FormaSesion.submit();"><i class="fas fa-sign-out-alt"></i> Cerrar Sesión</a>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div id="ContenedorEmergente" class="mi-overlay-unico">
      <div class="mi-modal-caja">
        ...
        <div class="mi-modal-body" style="padding: 20px;">
          <form action="sesion.php" method="POST" id="FormaLogin">
            <label style="font-weight: bold; color: #333">Usuario:</label>
            <input type="text" name="Correo" class="mi-input-azul" placeholder="Usuario" required />
            <label style="font-weight: bold; color: #333; margin-top: 10px; display: block;">Contraseña:</label>
          ...
          <div style="text-align: right; margin-top: 15px">
            <a href="restaurar.html#Restaurar" style="color: #666; font-size: 13px; text-decoration: none;">
  ...
  // --- 2. HTML DEL FOOTER ---
  const footerHTML = `
    <footer class="section_footer" style="background-color: #ab0a3d; color: white; padding: 20px 0; font-family: 'Montserrat', sans-serif; margin-top: auto;">
      <div class="container" style="text-align: center">
        <p style="font-size: 0.85rem; opacity: 0.9; margin: 0; text-transform: uppercase; letter-spacing: 1px; font-weight: 600;">
  ...
  // Conexión con el cuadro de Registro (ID: abrir-login-cuadro)
  const btnCuadroLogin = document.getElementById("abrir-login-cuadro");
  if (btnCuadroLogin) {
    btnCuadroLogin.addEventListener("click", abrirEmergente);
  }

  // Lógica Hamburguesa Móvil
