(function () {
  ...
  // Insertar los modales en el DOM al cargar
  document.body.insertAdjacentHTML("beforeend", modalesPadron);

  // --- 2. CONTROLADOR DE APERTURA (FORZADO MEDIANTE DELEGACIÓN) ---
  ...
  // --- 3. LÓGICA DE ENVÍO DE FORMULARIOS (REGISTRO Y LOGIN DE PROVEEDORES) ---
  document.addEventListener("submit", async (e) => {
    ...
    // --- MANEJO DE LOGIN DE PROVEEDORES ---
  ...
  // --- 4. REDIRECCIONES INTERNAS Y AYUDANTES GLOBALES ---
  ...
  // Mapeo seguro de las funciones de apertura en la ventana global para compatibilidad
