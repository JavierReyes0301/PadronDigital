document.addEventListener("DOMContentLoaded", async function () {
  // --- 0. INYECCIÓN DE ESTILOS (Sin tocar tu HTML) ---
  const headContenido = `
    <style>
  ...
  // --- 1. ICONOS (Recuperados de tu código original) ---
  const ICONOS = {
    inicio:
  ...
  // --- 2. RENDERIZADO COMPLETO DEL MENÚ ---
...
// --- FUNCIONES GLOBALES (Gestión de visibilidad) ---
