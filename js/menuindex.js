...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // IMPLEMENTACIÓN A: Gestión de Estilos Críticos
  const headContenido = `
    ...
    <style>
      ...
      /* Clase para optimizar el scroll */
  ...
  // --- 1. ICONOS SVG (Mantenemos tus originales) ---
  const iconos = {
  ...
  // --- 5. LÓGICA SCROLLSPY OPTIMIZADA ---
  // IMPLEMENTACIÓN B: Debounce/Throttling conceptual
  let isScrolling;
  window.addEventListener("scroll", () => {
    // Solo ejecutamos la lógica pesada cada 50ms para no trabar el navegador
