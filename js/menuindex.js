...
<div class="dropdown-menu dropdown-menu-right menu-guinda-compacto" aria-labelledby="navbarDropdown">
  <!-- Aquí llamamos a la función para mostrar el Perfil -->
  <a class="dropdown-item" href="javascript:void(0);" onclick="gestionarVisibilidadSeccion('estado-perfil');">
    <i class="fas fa-info-circle"></i> ESTADO DE PERFIL
  </a>
  
  <!-- Aquí llamamos a la función para mostrar la carga de Datos -->
  <a class="dropdown-item" href="javascript:void(0);" onclick="gestionarVisibilidadSeccion('actualizar-datos');">
