document.addEventListener("DOMContentLoaded", function () {
  ...
  // ============================================================
  // LÓGICA SCROLLSPY (CORREGIDA PARA ÚLTIMA SECCIÓN)
  // ============================================================
  window.addEventListener("scroll", () => {
    const sections = document.querySelectorAll("section[id]");
    const scrollY = window.pageYOffset;

    // Detectar si llegamos al final de la página (umbral de 100px)
    const isAtBottom =
    ...
    sections.forEach((current) => {
      ...
      if (navLink) {
        // Si estamos en el rango normal O si estamos al final y la sección es la última
        ...
        if (
          ...
          // Si forzamos la última, quitamos las demás para evitar doble marca
